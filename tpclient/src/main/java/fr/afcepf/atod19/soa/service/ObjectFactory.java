 ...
 * generated in the fr.afcepf.atod19.soa.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetAuteur_QNAME = new QName("http://service.soa.atod19.afcepf.fr/", "getAuteur");
    private final static QName _GetAuteurResponse_QNAME = new QName("http://service.soa.atod19.afcepf.fr/", "getAuteurResponse");
    private final static QName _TvaResponse_QNAME = new QName("http://service.soa.atod19.afcepf.fr/", "tvaResponse");
    private final static QName _Tva_QNAME = new QName("http://service.soa.atod19.afcepf.fr/", "tva");
    private final static QName _TtcResponse_QNAME = new QName("http://service.soa.atod19.afcepf.fr/", "ttcResponse");
    private final static QName _Ttc_QNAME = new QName("http://service.soa.atod19.afcepf.fr/", "ttc");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: fr.afcepf.atod19.soa.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.soa.atod19.afcepf.fr/", name = "getAuteur")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.soa.atod19.afcepf.fr/", name = "getAuteurResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.soa.atod19.afcepf.fr/", name = "tvaResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.soa.atod19.afcepf.fr/", name = "tva")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.soa.atod19.afcepf.fr/", name = "ttcResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.soa.atod19.afcepf.fr/", name = "ttc")
